...
//	}
	...
	public int recordDeleteByNumAndDate(Connection con, String num,String date)throws Exception {
		String sql = "delete from t_record where studentNumber=? and date=?";
		PreparedStatement pstmt=con.prepareStatement(sql);
