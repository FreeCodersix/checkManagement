...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/background1.jpg')">
		<div align="left" style="width: 80%;text-align:center;margin-left:150px;height:100px ;padding-top: 40px;padding-left: 30px;" ><font color="white"  size="10" >考勤管理系统</font></div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="resultServlet"><i class="icon-chevron-right"></i>补勤申请结果</a></li>
