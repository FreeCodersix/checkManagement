...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/background1.jpg')">
		<div align="left" style="width: 80%;text-align:center;margin-left:150px;height:100px ;padding-top: 40px;padding-left: 30px;" ><font color="white"  size="12" >考勤管理系统</font></div>
		<div style="padding-top: 3px;float:right;padding-right: 20px;">当前用户：&nbsp;<font color="red" >${currentUser.userName }</font></div>
	</div>
</div>
<br>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="dormBuild?action=list"><i class="icon-chevron-right"></i>年级管理</a></li>
					<li><a href="dormManager?action=list"><i class="icon-chevron-right"></i>班级管理</a></li>
					...
					<li><a href="queryapply"><i class="icon-chevron-right"></i>补勤申请</a></li>
